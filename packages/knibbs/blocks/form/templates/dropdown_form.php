...
<div class="row">
    <div id="dropdown<?php  echo $bID; ?>-container" class="dropdown-container">
        <div class="dropdown-header" onclick="dropdown<?php  echo $bID; ?>()">
            <h2 class="mb-none">Enquire Now<span class="dropdown-click<?php  echo $bID; ?>"><i class="fa fa-chevron-down dropdown-icon"></i></span></h2>
        </div>
        <div id="dropdown<?php  echo $bID; ?>" style="display:none;" class="dropdown-content">
	        ...
	        </div><?php // End Form Block ?>
        </div><?php // End Dropdown ?>
    </div><?php // End Dropdown Container ?>
</div><?php // End Row ?>

<script>
function dropdown<?php  echo $bID; ?>() {
$('#dropdown<?php  echo $bID; ?>').slideToggle();
	if ($('.dropdown-click<?php  echo $bID; ?>').html() == '<i class="fa fa-chevron-down dropdown-icon"></i>') {
	$('.dropdown-click<?php  echo $bID; ?>').html('<i class="fa fa-chevron-up dropdown-icon"></i>');
	}
	else { $('.dropdown-click<?php  echo $bID; ?>').html('<i class="fa fa-chevron-down dropdown-icon"></i>'); }
}
</script>